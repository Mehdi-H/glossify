...
class StreetLamp:
    """
    💡 Represents a smart street lighting unit in an urban environment.
...
class ElectricalCabinet:
    """
    ⚡ Represents an electrical distribution cabinet in the smart city infrastructure.
...
class AirQualitySensor:
    """
    🌫 Represents a sensor device for monitoring air quality in urban environments.
...
class TrafficFlowSensor:
    """
    🚗 Represents a sensor for monitoring and analyzing traffic flow in urban areas.
